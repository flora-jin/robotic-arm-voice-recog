...
# SSL Content fix (was required on personal laptop - may not be needed in ubuntu 22.04 alienware)
...
with mic as source:
    ...
    while True:
        try:
            ...
            # Convert raw bytes (16-bit int) to NumPy float32 because we set sample_rate=16000 above, this data is already 16k
